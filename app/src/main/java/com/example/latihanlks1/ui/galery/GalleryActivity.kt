...
class GalleryActivity : AppCompatActivity() {
        ...
        galleryadapter = GalleryAdapter { photo ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
                ...
                detailObject?.let {
                    ...
                    val album = Album(id = idCat, name = nameCat , descrption = desc, imageUrl = imgurl)
    ...
    private suspend fun postImage(file: File) : JSONObject?{
        return withContext(Dispatchers.IO){
            NetworkApi("https://api.thecatapi.com/v1/images/upload", method = "POST")
